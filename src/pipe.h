...
// ★ vel_obstaculos: indica a velocidade inicial dos obstáculos em relação ao personagem.(em pixels)
// ★ inc_vel_obstaculos: indica o quanto a velocidade dos obstáculos deve ser incrementada a cada aumento de dificuldade. (empixels)
